---
name: supertools-last
description: Open supertools on the latest rendered assistant message and use the returned annotations to revise that message or continue.
disable-model-invocation: true
---

# supertools Last

Use this skill when the user wants to annotate the latest assistant response in supertools.
...
```bash
SUPERTOOLS_ORIGIN=antigravity-cli supertools last
```
